describe('Hackathon 2 Test', () => {
    ...
    // checkpoint 4 forgive
    it('#4 [Easy][Mercy] Enable moving in right direction and step changing with keyboard (5%)', () => {
        cy.visit('/')
        cy.get('#value-3-0').should('have.text', 'NCTU')
        cy.get('#value-3-1').should('have.text', 'NCTU')
    ...
    // checkpoint 4
    it('#4 [Easy][Normal] Enable moving in right direction and step changing with keyboard (10%)', () => {
        cy.visit('/')
        cy.get('#value-3-0').should('have.text', 'NCTU')
        cy.get('#value-3-1').should('have.text', 'NCTU')
        cy.get('#general-step-value').should('have.text', '0')
